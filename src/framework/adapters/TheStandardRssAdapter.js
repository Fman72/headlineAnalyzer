...
const AdapterApiHelper = new ApiHelper('https://thestandard.org.nz/', {contentType: 'xml'});
...
class TheStandardRssAdapter extends SourceAdapter {
...
export default TheStandardRssAdapter;
